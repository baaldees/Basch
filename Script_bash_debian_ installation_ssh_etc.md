...
| Noms d'hôtes en adresses IP | nano /etc/hosts |
| Identifie votre machine | nano /etc/hostname |
| Sources de résolution de noms | nano /etc/nsswitch.conf |
| Date | date |
| bashrc | nano /root/.bashrc |
| Configurer les interfaces réseau | nano /etc/network/interfaces |
